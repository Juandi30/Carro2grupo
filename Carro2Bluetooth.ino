// PINS
//  Motor A for Wheels
int const ENA_WHEEL = 11;
int const INA_1W = 13;
int const INA_2W = 12;
//  Motor B for Wheels
int const ENB_WHEEL = 9;
int const INB_3W = 10;
int const INB_4W = 8;
//  Motor A for Suspension
int const ENA_SUSP = 5;
int const IN1 = 6;
int const IN2 = 7;
...
void setup() {
  ...
  pinMode(INA_1W, OUTPUT);
  pinMode(INA_2W, OUTPUT);
  pinMode(INB_3W, OUTPUT);
  pinMode(INB_4W, OUTPUT);
  // Suspension
  ...
  digitalWrite(INA_1W, LOW);
  digitalWrite(INA_2W, LOW);
  digitalWrite(INB_3W, LOW);
  digitalWrite(INB_4W, LOW);
  ...
  if (suspension_mode) {
    ...
    switch (bluetooth) {
      case 'S':
        ...
        break;
      case 'F':
        ControlWheel('F', wheel_speed);
        break;
      case 'B':
        ControlWheel('B', wheel_speed);
        break;
      case 'R':
        ControlWheel('R', wheel_speed);
        break;
      case 'L':
        ControlWheel('L', wheel_speed);
        break;
      default:
        break;
    }
 ...
 */
void ControlWheel(char dir, int speed) {
  int newspeed;
  ...
  switch (dir) {
    ...
    case 'F':
      ...
      digitalWrite(INA_2W, LOW);
      digitalWrite(INB_3W, LOW);
      digitalWrite(INB_4W, HIGH);
      digitalWrite(INA_1W, HIGH);
      break;
    case 'B':
      analogWrite(ENA_WHEEL, newspeed);
      analogWrite(ENB_WHEEL, newspeed);
      digitalWrite(INA_2W, HIGH);
      digitalWrite(INB_3W, HIGH);
      digitalWrite(INB_4W, LOW);
      digitalWrite(INA_1W, LOW);
      break;
    case 'R':
